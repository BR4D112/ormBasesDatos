 ...
 */
// permite crear un JLabel
//con un mensaje en el fondo del texto, sin que aparezca
// la letra para ser editable (marca de agua)
public class PromptText extends JLabel implements FocusListener, DocumentListener {
	...
	public PromptText(String text, JTextComponent component) {
	...
	public PromptText(String text, JTextComponent component, Show show) {

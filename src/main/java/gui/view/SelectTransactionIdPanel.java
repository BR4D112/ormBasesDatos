...
import gui.view.SelectTransactionIdPanel.ActionListerSetValues;
...
public class SelectTransactionIdPanel extends JPanel {
    ...
    private JLabel transaccionselected;
    
    private int idTransaccion;

    public JLabel getTransaccionselected() {
        return transaccionselected;
    }

    public void setTransaccionselected(JLabel transaccionselected) {
        this.transaccionselected = transaccionselected;
    }

    public SelectTransactionIdPanel(ActionListener listener) {
    ...
    public void initComponents(ActionListener listener) {
        ...
        searchIdButton = new JButton("Búscar");
        ...
        searchIdButton.addActionListener(new ActionListerSetValues());
        searchIdButton.setActionCommand("BuscarId");
    ...
    public class ActionListerSetValues implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {
            String value
                    = InformationTransactionPanel.textoFactura;
            transaccionselected.setText(value + " " + comboBox.getSelectedItem());
            idTransaccion = Integer.parseInt(comboBox.getSelectedItem()+"");
        }
